...
const Swipper = () => {
  return (
    <div className="container my-20">
      ...
      >
        <SwiperSlide>
          <div className="max-lg:h-[650px] max-lg:w-full max-md:h-[550px] max-sm:h-[450px]  h-[700px] bg-cover bg-no-repeat bg-center bg-[url('https://static1.srcdn.com/wordpress/wp-content/uploads/2024/03/po-in-kung-fu-panda-4.jpg')]"></div>
        </SwiperSlide>
        <SwiperSlide>
